...
describe("About Higher Order Functions", function () {
  ...
  it("should use 'reduce' to update the same result on each iteration", function () {
    var numbers = [1, 2, 3]; // reduce is just like the inject method for ruby 
  ...
  //!!! any is deprecated, now you use "some" --> onlyEven.some(isEven); 
  ...
  //looks like we need to use new_arr.concat.apply(new_arr, nested_arr) instead of flatten
  // also, can use reduce: 
  // var flattened = [[0, 1], [33, 4, 5] ].reduce(function(a, b) { 
  // return a.concat(b);
  // });
  // flattened is [0, 1, 33, 4, 5] 
